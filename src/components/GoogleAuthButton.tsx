...
export const GoogleAuthButton = () => {
    return (
        <Link
            className="flex items-center justify-center gap-3 w-full px-4 py-2 group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 font-medium"
        ...
        >
            ...
            <div className="absolute inline-flex h-12 w-full translate-x-[100%] items-center justify-center bg-blue-500 px-6 text-neutral-50 transition duration-300 group-hover:translate-x-0">
                Grant Access Your Google Docs and Drive
            </div>
        </Link>
    );
};
